...
wa = WhatsApp(
    ...
    token=
    "EAAOxaNntzsEBO16xncaV6XC4UPLvKbT56okNPHnsJMxYGhZC1lldcgC1eIuAxwYlkgglX9ZClypXd4KNVGpS6cgD7jS0GiQX3m0a8E8tAgzowwHdQwit0pcX7VogBTLBzCbw2TCwnba6mAjRRW8nPEUynVRsfZCWb9PVk9l7f7xsUbAfYXL3I6eksEGzo8w2oRtbA5nkaxCBBtj6ipLbBjZBglIZD",
    server=fastapi_app,
    callback_url=
    ...
    webhook_challenge_delay=30  # Increase this value, e.g., to 30 seconds
)
